...
from python2018.SVM.commons import Oracles, compute_error
from python2018.SVM.algorithms import  GD, GDstr, AGD, AGDstr, LSGD, LSAGD, AGDR, LSAGDR, QNM, NM, SGD, SAG, SVR
...
def main():
    ...
    parameter = {}
    parameter['Lips'] = LA.norm(np.transpose(A), 2)*LA.norm(A, 2)/(2 * n * h) + sigma
